...
public class MainActivity extends BaseActivity {
    ...
    @OnClick({R.id.btn_scroll_view, R.id.btn_drag_fill_blank_question,
    ...
    public void onViewClicked(View view) {
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_drag_fill_blank_question:
                intent = new Intent(this, DragFillBlankQuestionActivity.class);
                break;
            ...
            case R.id.btn_span_flag:
                intent = new Intent(this, SpanFlagActivity.class);
                break;
            ...
            case R.id.btn_image_choice_question:
                intent = new Intent(this, ImageChoiceQuestionActivity.class);
                break;

            case R.id.btn_choice_question:
                intent = new Intent(this, ChoiceQuestionActivity.class);
                break;

            case R.id.btn_time_axis_vertical:
                intent = new Intent(this, TimeAxisVerticalActivity.class);
                break;
